...
public class TinyGPautomated {
    ...
    public static void main(String[] args) {
        ...
        List < String > files = findFiles(folderPath);

        for (String filename: files) {
            PLIK = "done " + filename;
            System.out.println("Processing file: " + PLIK);
            TinyGPautomated TinyGPautomated = new TinyGPautomated(filename, seed);
            TinyGPautomated.evolve();
        }
    }

    private static List < String > findFiles(String folderPath) {
    ...
    public TinyGPautomated(String filename, long randomSeed) {
    ...
    private int printGeneration(char[] buffer, int buffercounter, String output) {
        ...
        if (buffer[buffercounter] < FSET_START) {
            if (buffer[buffercounter] < variableCount) {
                ...
                double
                var = variables[buffer[buffercounter]];
